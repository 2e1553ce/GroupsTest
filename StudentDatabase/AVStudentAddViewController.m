...
#define CONTENT_WIDTH self.view.frame.size.width
#define CONTENT_HEIGHT self.view.frame.size.height
...
@interface AVStudentAddViewController () <UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@property (strong, nonatomic) NSPersistentContainer *persistentContainer;

@end

@implementation AVStudentAddViewController
...
- (void)createStudentFields {
    ...
    [self.saveButton addTarget:self
               ...
               forControlEvents:UIControlEventTouchUpInside];
    [self.saveButton setTitle:@"Добавить студента" forState:UIControlStateNormal];
...
- (void)saveButtonAction:(UIButton *)sender {
    ...
    if([firstName isEqualToString:@""] || [lastName isEqualToString:@""]) {
        ...
        NSManagedObject *student = [NSEntityDescription insertNewObjectForEntityForName:@"Students" inManagedObjectContext:context];
        [student setValue:firstName forKey:@"firstName"];
        [student setValue:lastName forKey:@"lastName"];
        [student setValue:self.groupName forKey:@"groupName"];
        
        if(![self.birthdayTextField.text isEqualToString:@""]) {
            [student setValue:self.birthdayTextField.text forKey:@"birthday"];
        }
        ...
        if(self.photoPath != nil || ![self.photoPath isEqualToString:@""]) {
            [student setValue:self.photoPath forKey:@"photoPath"];
        }
